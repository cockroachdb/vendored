...
// Keep these in sync with github.com/cockroachdb/gostdlib/go/format/format.go.
const (
	tabWidth    = 8
	...
	//
	// This value is defined in github.com/cockroachdb/gostdlib/go/printer specifically for github.com/cockroachdb/gostdlib/go/format and github.com/cockroachdb/gostdlib/cmd/gofmt.
