...
func (Numeral) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_more_test_objects_9a1c8db5a1b16e94, []int{0}
}
...
func (*SimpleSlice3) Descriptor() ([]byte, []int) {
	return fileDescriptor_more_test_objects_9a1c8db5a1b16e94, []int{1}
}
...
func (*SimpleMap3) Descriptor() ([]byte, []int) {
	return fileDescriptor_more_test_objects_9a1c8db5a1b16e94, []int{2}
}
...
func (*SimpleNull3) Descriptor() ([]byte, []int) {
	return fileDescriptor_more_test_objects_9a1c8db5a1b16e94, []int{3}
}
...
func (*Mappy) Descriptor() ([]byte, []int) {
	return fileDescriptor_more_test_objects_9a1c8db5a1b16e94, []int{4}
}
...
func init() {
	proto.RegisterFile("more_test_objects.proto", fileDescriptor_more_test_objects_9a1c8db5a1b16e94)
}

var fileDescriptor_more_test_objects_9a1c8db5a1b16e94 = []byte{
