...
func (*M3) Descriptor() ([]byte, []int) {
	return fileDescriptor_m3_df97d3699324287d, []int{0}
}
...
func init() { proto.RegisterFile("imports/test_a_2/m3.proto", fileDescriptor_m3_df97d3699324287d) }

var fileDescriptor_m3_df97d3699324287d = []byte{
