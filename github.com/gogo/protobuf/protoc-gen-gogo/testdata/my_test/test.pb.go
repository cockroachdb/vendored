...
func (HatType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{0}
}
...
func (Days) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{1}
}
...
func (Request_Color) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{0, 0}
}
...
func (Reply_Entry_Game) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{1, 0, 0}
}
...
func (*Reply_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{1, 0}
}
...
func (*OtherBase) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{2}
}
...
func (*ReplyExtensions) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{3}
}
...
func (*OtherReplyExtensions) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{4}
}
...
func (*OldReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{5}
}
...
func (*Communique) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{6}
}
...
func (*Communique_SomeGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{6, 0}
}
...
func (*Communique_Delta) Descriptor() ([]byte, []int) {
	return fileDescriptor_test_d567972f74e43284, []int{6, 1}
}
...
func init() { proto.RegisterFile("my_test/test.proto", fileDescriptor_test_d567972f74e43284) }

var fileDescriptor_test_d567972f74e43284 = []byte{
