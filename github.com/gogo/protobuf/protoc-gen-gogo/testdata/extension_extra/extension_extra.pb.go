...
func (*ExtraMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_extension_extra_3d33f019555679f7, []int{0}
}
...
func init() {
	proto.RegisterFile("extension_extra/extension_extra.proto", fileDescriptor_extension_extra_3d33f019555679f7)
}

var fileDescriptor_extension_extra_3d33f019555679f7 = []byte{
