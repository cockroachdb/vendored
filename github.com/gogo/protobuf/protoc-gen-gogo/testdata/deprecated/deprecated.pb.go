...
func (DeprecatedEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_deprecated_6eed3536b3d526bc, []int{0}
}
...
func (*DeprecatedResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_deprecated_6eed3536b3d526bc, []int{1}
}
...
func init() {
	proto.RegisterFile("deprecated/deprecated.proto", fileDescriptor_deprecated_6eed3536b3d526bc)
}

var fileDescriptor_deprecated_6eed3536b3d526bc = []byte{
