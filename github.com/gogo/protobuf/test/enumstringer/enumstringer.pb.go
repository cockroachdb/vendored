...
func (TheTestEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_enumstringer_c1147000565b59f7, []int{0}
}
...
func (*NinOptEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_enumstringer_c1147000565b59f7, []int{1}
}
...
func (*NidRepEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_enumstringer_c1147000565b59f7, []int{2}
}
...
func (*NinRepEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_enumstringer_c1147000565b59f7, []int{3}
}
...
func init() { proto.RegisterFile("enumstringer.proto", fileDescriptor_enumstringer_c1147000565b59f7) }

var fileDescriptor_enumstringer_c1147000565b59f7 = []byte{
