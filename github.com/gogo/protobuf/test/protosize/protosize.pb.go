...
func (*SizeMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_protosize_b08feee48ae4dbd0, []int{0}
}
...
func init() { proto.RegisterFile("protosize.proto", fileDescriptor_protosize_b08feee48ae4dbd0) }

var fileDescriptor_protosize_b08feee48ae4dbd0 = []byte{
