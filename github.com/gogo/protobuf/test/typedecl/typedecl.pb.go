...
func (*Dropped) Descriptor() ([]byte, []int) {
	return fileDescriptor_typedecl_ffdd189daaf58863, []int{0}
}
...
func (*DroppedWithoutGetters) Descriptor() ([]byte, []int) {
	return fileDescriptor_typedecl_ffdd189daaf58863, []int{1}
}
...
func (*Kept) Descriptor() ([]byte, []int) {
	return fileDescriptor_typedecl_ffdd189daaf58863, []int{2}
}
...
func init() { proto.RegisterFile("typedecl.proto", fileDescriptor_typedecl_ffdd189daaf58863) }

var fileDescriptor_typedecl_ffdd189daaf58863 = []byte{
