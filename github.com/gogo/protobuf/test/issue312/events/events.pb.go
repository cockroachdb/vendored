...
func (*Subtype) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_76ef3331f42dc962, []int{0}
}
...
func init() { proto.RegisterFile("events.proto", fileDescriptor_events_76ef3331f42dc962) }

var fileDescriptor_events_76ef3331f42dc962 = []byte{
