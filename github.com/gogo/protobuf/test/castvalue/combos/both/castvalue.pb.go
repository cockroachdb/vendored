...
func (*Castaway) Descriptor() ([]byte, []int) {
	return fileDescriptor_castvalue_4d47d4a5a77b9bf1, []int{0}
}
...
func (*Wilson) Descriptor() ([]byte, []int) {
	return fileDescriptor_castvalue_4d47d4a5a77b9bf1, []int{1}
}
...
func init() {
	proto.RegisterFile("combos/both/castvalue.proto", fileDescriptor_castvalue_4d47d4a5a77b9bf1)
}

var fileDescriptor_castvalue_4d47d4a5a77b9bf1 = []byte{
