...
func (*Castaway) Descriptor() ([]byte, []int) {
	return fileDescriptor_castvalue_613b4e654566e8da, []int{0}
}
...
func (*Wilson) Descriptor() ([]byte, []int) {
	return fileDescriptor_castvalue_613b4e654566e8da, []int{1}
}
...
func init() {
	proto.RegisterFile("combos/marshaler/castvalue.proto", fileDescriptor_castvalue_613b4e654566e8da)
}

var fileDescriptor_castvalue_613b4e654566e8da = []byte{
