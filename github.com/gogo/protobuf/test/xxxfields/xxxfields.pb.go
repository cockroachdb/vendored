...
func (*NativeWithSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_d6de5e731d53a1be, []int{0}
}
...
func (*StructWithSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_d6de5e731d53a1be, []int{1}
}
...
func (*NativeWithoutSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_d6de5e731d53a1be, []int{2}
}
...
func (*StructWithoutSizeCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_xxxfields_d6de5e731d53a1be, []int{3}
}
...
func init() { proto.RegisterFile("xxxfields.proto", fileDescriptor_xxxfields_d6de5e731d53a1be) }

var fileDescriptor_xxxfields_d6de5e731d53a1be = []byte{
