...
func (*IndexQueries) Descriptor() ([]byte, []int) {
	return fileDescriptor_indeximport_2347338228e0a86c, []int{0}
}
...
func init() { proto.RegisterFile("indeximport.proto", fileDescriptor_indeximport_2347338228e0a86c) }

var fileDescriptor_indeximport_2347338228e0a86c = []byte{
