...
func (*IndexQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_index_06d506530fa6e3b3, []int{0}
}
...
func init() { proto.RegisterFile("index.proto", fileDescriptor_index_06d506530fa6e3b3) }

var fileDescriptor_index_06d506530fa6e3b3 = []byte{
