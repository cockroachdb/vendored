...
func (*SubObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_subproto_e2b7b94d9cc9f603, []int{0}
}
...
func init() { proto.RegisterFile("subpkg/subproto.proto", fileDescriptor_subproto_e2b7b94d9cc9f603) }

var fileDescriptor_subproto_e2b7b94d9cc9f603 = []byte{
