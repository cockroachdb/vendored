...
func (*C) Descriptor() ([]byte, []int) {
	return fileDescriptor_c_be5b10bf6efb19d5, []int{0}
}
...
func init() { proto.RegisterFile("c.proto", fileDescriptor_c_be5b10bf6efb19d5) }

var fileDescriptor_c_be5b10bf6efb19d5 = []byte{
