...
func (*A) Descriptor() ([]byte, []int) {
	return fileDescriptor_a_f4afcf75a484927d, []int{0}
}
...
func init() { proto.RegisterFile("a.proto", fileDescriptor_a_f4afcf75a484927d) }

var fileDescriptor_a_f4afcf75a484927d = []byte{
