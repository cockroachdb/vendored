...
func (*MapTest) Descriptor() ([]byte, []int) {
	return fileDescriptor_map_f2664005b9bcfb41, []int{0}
}
...
func (*FakeMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_map_f2664005b9bcfb41, []int{1}
}
...
func (*FakeMapEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_map_f2664005b9bcfb41, []int{2}
}
...
func init() { proto.RegisterFile("combos/marshaler/map.proto", fileDescriptor_map_f2664005b9bcfb41) }

var fileDescriptor_map_f2664005b9bcfb41 = []byte{
