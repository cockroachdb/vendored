...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_9b15cf8840aa91d7, []int{0}
}
...
func (*SampleOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_9b15cf8840aa91d7, []int{1}
}
...
func init() { proto.RegisterFile("combos/neither/one.proto", fileDescriptor_one_9b15cf8840aa91d7) }

var fileDescriptor_one_9b15cf8840aa91d7 = []byte{
