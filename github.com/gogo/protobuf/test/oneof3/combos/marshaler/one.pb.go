...
func (*Subby) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_b7c735bee82a6e60, []int{0}
}
...
func (*SampleOneOf) Descriptor() ([]byte, []int) {
	return fileDescriptor_one_b7c735bee82a6e60, []int{1}
}
...
func init() { proto.RegisterFile("combos/marshaler/one.proto", fileDescriptor_one_b7c735bee82a6e60) }

var fileDescriptor_one_b7c735bee82a6e60 = []byte{
