...
func (MapEnum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_a7e7df88bc591fe2, []int{0}
}
...
func (*CustomMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_a7e7df88bc591fe2, []int{1}
}
...
func (*AllMaps) Descriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_a7e7df88bc591fe2, []int{2}
}
...
func (*AllMapsOrdered) Descriptor() ([]byte, []int) {
	return fileDescriptor_mapsproto2_a7e7df88bc591fe2, []int{3}
}
...
func init() {
	proto.RegisterFile("combos/marshaler/mapsproto2.proto", fileDescriptor_mapsproto2_a7e7df88bc591fe2)
}

var fileDescriptor_mapsproto2_a7e7df88bc591fe2 = []byte{
