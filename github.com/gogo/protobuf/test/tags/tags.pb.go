...
func (*Outside) Descriptor() ([]byte, []int) {
	return fileDescriptor_tags_f571c0322f8b86ab, []int{0}
}
...
func (*Inside) Descriptor() ([]byte, []int) {
	return fileDescriptor_tags_f571c0322f8b86ab, []int{1}
}
...
func init() { proto.RegisterFile("tags.proto", fileDescriptor_tags_f571c0322f8b86ab) }

var fileDescriptor_tags_f571c0322f8b86ab = []byte{
