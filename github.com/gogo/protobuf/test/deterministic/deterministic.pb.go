...
func (*OrderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{0}
}
...
func (*UnorderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{1}
}
...
func (*MapNoMarshaler) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{2}
}
...
func (*NestedOrderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{3}
}
...
func (*NestedMap1) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{4}
}
...
func (*NestedUnorderedMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{5}
}
...
func (*NestedMap2) Descriptor() ([]byte, []int) {
	return fileDescriptor_deterministic_5e3af3c7cd7a5408, []int{6}
}
...
func init() { proto.RegisterFile("deterministic.proto", fileDescriptor_deterministic_5e3af3c7cd7a5408) }

var fileDescriptor_deterministic_5e3af3c7cd7a5408 = []byte{
